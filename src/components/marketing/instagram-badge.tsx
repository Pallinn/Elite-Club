...
export function InstagramBadge() {
  return (
    <Link
      ...
      className="fixed right-4 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-40 flex items-center gap-2 rounded-full border border-white/10 bg-black/60 px-3 py-2 backdrop-blur transition-colors hover:bg-white/20"
    >
